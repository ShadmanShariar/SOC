    ...
    <div className="flex-1 overflow-hidden">
      <main className="p-6 flex-1 overflow-y-auto">
        ...
        <div className="grid h-[calc(100vh-13rem)] grid-cols-[25%_75%] gap-6">
          ...
          <section className="min-w-0 shadow-[0_0_30px_rgba(37,99,235,0.08)] rounded-2xl bg-zinc-900 border-white/10 border-1 border-solid flex flex-col overflow-hidden">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="rounded-xl bg-zinc-950 text-sm leading-5 border-white/10 border-1 border-solid px-4 py-3">
                        Intelligent Security SOC Platform
                      </div>
                    </div>
                    <div className="flex flex-col gap-2">
                      <div className="text-[#9f9fa9] text-xs leading-4">
            ...
            <div className="bg-zinc-900 border-white/10 border-t-1 border-r-0 border-b-0 border-l-0 border-solid flex px-6 py-4 justify-between items-center">

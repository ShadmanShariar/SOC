  ...
  return (
    <div>
      <div className="min-h-screen bg-zinc-950 text-neutral-50 w-full h-fit overflow-hidden h-fit min-h-screen w-screen min-w-screen max-w-screen overflow-visible">
        <div className="min-h-screen bg-blue-500/12 flex">
          <aside className="shrink-0 bg-[linear-gradient(180deg,#0D1226_0%,#0A0E1A_100%)] border-white/10 border-t-0 border-r-1 border-b-0 border-l-0 border-solid px-2 py-4 w-16">
            <div className="flex flex-col items-stretch gap-2 h-full">
              <div className="shadow-[0_0_24px_rgba(59,130,246,0.18)] rounded-xl bg-zinc-900/80 text-[#155dfc] border-white/10 border-1 border-solid flex justify-center items-center h-12">
                <LayoutDashboard className="size-5" />
              </div>
              <div className="flex flex-col flex-1 gap-2">
                <button className="shadow-[0_0_24px_rgba(59,130,246,0.35)] rounded-xl bg-[#155dfc] text-[#1c398e] border-[#155dfc]/40 border-1 border-solid flex justify-center items-center h-11">
                  <LayoutDashboard className="size-5" />
                </button>
                <button className="rounded-xl bg-zinc-900/70 text-[#9f9fa9] border-white/10 border-1 border-solid flex justify-center items-center h-11">

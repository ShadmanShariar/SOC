    ...
    <div>
      <div className="bg-zinc-950 text-neutral-50 w-full h-fit h-fit min-h-screen w-screen min-w-screen max-w-screen overflow-visible">
        <div className="min-h-[1080px] flex w-full">
          <aside className="shrink-0 bg-zinc-900 border-white/10 border-t-0 border-r-1 border-b-0 border-l-0 border-solid flex p-6 flex-col gap-6 w-64">
            ...
            <nav className="flex flex-col gap-1">
              <a className="rounded-lg text-[#9f9fa9] text-sm leading-5 flex px-3 py-2.5 items-center gap-3">
              ...
              <a className="shadow-[0_0_20px_oklch(0.546_0.245_262.881/0.45)] font-medium rounded-lg bg-[#155dfc] text-[#1c398e] text-sm leading-5 flex px-3 py-2.5 items-center gap-3">
            ...
            <div className="rounded-lg border-white/10 border-1 border-solid flex mt-auto p-3 items-center gap-3">
          ...
          <div className="flex flex-col flex-1">
            <header className="bg-zinc-900 border-white/10 border-t-0 border-r-0 border-b-1 border-l-0 border-solid flex px-8 py-4 justify-between items-center">
              <div className="flex flex-col gap-1">
                <div className="text-[#9f9fa9] text-xs leading-4 flex items-center gap-2">
                  <span>SOC</span>
                  <ChevronRight className="size-3" />
                  <span className="text-neutral-50">{`Threat Hunting & UBA`}</span>
                </div>
                <h1 className="font-semibold text-xl leading-7 tracking-tight">{`Threat Hunting & User Behavior Analytics`}</h1>
              </div>
              <div className="flex items-center gap-4">
                <div className="rounded-lg bg-zinc-800 border-white/15 border-1 border-solid flex px-3 items-center gap-2 w-80 h-9">
                  <Search className="size-4 text-[#9f9fa9]" />
                  <input
                    className="bg-transparent outline-none text-neutral-50 text-sm leading-5 w-full"
                    placeholder="Search hosts, users, IOCs..."
                  />
                </div>
                <Button
                ...
                <div className="border-white/10 border-t-0 border-r-0 border-b-0 border-l-1 border-solid flex pl-4 items-center gap-3">
                  <img
                    alt="Analyst"

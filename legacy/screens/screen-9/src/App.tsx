    ...
    <div>
      <div className="bg-zinc-950 text-neutral-50 w-full h-fit h-fit min-h-screen w-screen min-w-screen max-w-screen overflow-visible">
        <div className="flex w-full h-screen overflow-hidden" style={{}}>
          <div className="fixed z-50 bg-[oklch(0.21_0.006_285.885)] border-white/10 border-t-0 border-r-0 border-b-1 border-l-0 border-solid flex inset-x-0 top-0 px-4 items-center gap-4 h-16">
            <div className="shrink-0 flex items-center gap-2 w-64">
              <div className="relative rounded-lg bg-[#155dfc]/20 border-[#155dfc]/40 border-1 border-solid flex justify-center items-center w-9 h-9">
                <Shield className="size-5 text-[#155dfc]" />
                <div className="rounded-full bg-[#155dfc] absolute -right-0.5 -top-0.5 w-2 h-2" />
              </div>
              <div>
                <p className="font-bold text-neutral-50 text-sm leading-5 tracking-wide">
                  SENTINEL AI
                </p>
                <p className="leading-none text-[#9f9fa9] text-[10px]">
                  SOC Platform
                </p>
              </div>
            </div>
            <div className="flex justify-center flex-1">
              <div className="relative w-120">
                ...
                <input
                  className="bg-[oklch(1_0_0/8%)] rounded-lg text-neutral-50 text-sm leading-5 border-white/10 border-1 border-solid pl-9 pr-4 w-full h-9"
            ...
            <div className="flex ml-auto items-center gap-4">
              ...
              <div className="relative">
                ...
                <span className="font-bold rounded-full bg-[#ff6467] text-white text-[9px] flex absolute -right-1.5 -top-1.5 justify-center items-center w-4 h-4">
                  7
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div className="font-bold rounded-full bg-[#155dfc]/30 text-[#155dfc] text-xs leading-4 border-[#155dfc]/50 border-1 border-solid flex justify-center items-center w-8 h-8">
                  AC
                </div>
                <div>
                  <p className="leading-none font-semibold text-neutral-50 text-xs leading-4">
                    Alex Carter
                  </p>
                  <p className="text-[#9f9fa9] text-[10px]">SOC Lead</p>
                </div>
                <div className="flex items-center gap-1">
                  <div className="bg-[oklch(0.696_0.17_162.48)] animate-pulse rounded-full w-2 h-2" />
                  <span className="text-[oklch(0.696_0.17_162.48)] font-semibold text-[10px]">
                    LIVE
                  </span>
                </div>
              </div>
          ...
          <div className="flex pt-16 h-screen">
            <div className="fixed bg-[oklch(0.21_0.006_285.885)] z-40 overflow-y-auto border-white/10 border-t-0 border-r-1 border-b-0 border-l-0 border-solid flex left-0 top-16 bottom-0 py-4 flex-col items-center gap-1 w-16">
              <div className="flex flex-col items-center gap-1 w-full">
                <div className="group relative cursor-pointer transition-all rounded-lg text-[#9f9fa9] flex justify-center items-center w-10 h-10">
                  <LayoutDashboard className="size-5" />
                  <div className="whitespace-nowrap pointer-events-none z-50 opacity-0 rounded-sm bg-zinc-900 text-neutral-50 text-xs leading-4 border-white/10 border-1 border-solid absolute left-12 px-2 py-1">
                    Dashboard
                  </div>
                </div>
                <div className="group relative cursor-pointer transition-all rounded-lg text-[#9f9fa9] flex justify-center items-center w-10 h-10">
                ...
                <div className="group relative cursor-pointer transition-all rounded-lg bg-[#155dfc] text-[#1c398e] flex justify-center items-center w-10 h-10">
            ...
            <div className="overflow-y-auto bg-zinc-950 ml-16 flex-1">
              <div className="p-8">

  ...
  return (
    <div>
      <div className="bg-zinc-950 text-neutral-50 w-full h-fit h-fit min-h-screen w-screen min-w-screen max-w-screen overflow-visible">
        <div className="min-h-screen bg-blue-500/18 flex overflow-hidden">
          <aside className="shrink-0 bg-[linear-gradient(180deg,#0D1226_0%,#0A0E1A_100%)] border-white/10 border-t-0 border-r-1 border-b-0 border-l-0 border-solid px-2 py-4 w-20">
            <div className="flex flex-col gap-2 h-full">
              <div className="size-14 shadow-[0_0_24px_rgba(59,130,246,0.18)] rounded-2xl bg-zinc-900 text-[#155dfc] border-white/10 border-1 border-solid flex justify-center items-center">
                <ShieldCheck className="size-6" />
              </div>
              <div className="flex flex-col flex-1 gap-2">
                <div className="flex flex-col gap-2">
                  <div className="shadow-[0_0_24px_rgba(59,130,246,0.35)] rounded-2xl bg-[#155dfc] text-[#1c398e] border-[#155dfc]/40 border-1 border-solid">
                    <div className="flex justify-center items-center h-12">
                      <LayoutDashboard className="size-5" />
                    </div>
                  </div>
                  <div className="rounded-2xl bg-zinc-900 text-[#9f9fa9] border-white/10 border-1 border-solid">
                    <div className="flex justify-center items-center h-12">
          ...
          <div className="min-w-0 flex flex-col flex-1">
            <header className="bg-[linear-gradient(180deg,#0D1226_0%,#0B1020_100%)] shadow-[0_8px_30px_rgba(0,0,0,0.35)] border-white/10 border-t-0 border-r-0 border-b-1 border-l-0 border-solid flex px-6 justify-between items-center h-20">
              ...
              <div className="shadow-[0_0_24px_rgba(59,130,246,0.08)] rounded-full bg-zinc-900 border-white/10 border-1 border-solid flex px-4 py-3 items-center gap-3 w-168">
                <Search className="size-4 text-[#9f9fa9]" />
                <div className="text-[#9f9fa9] text-sm leading-5">
                  Search threats, assets, incidents…
                </div>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div className="relative size-11 rounded-full bg-zinc-900 text-[#9f9fa9] border-white/10 border-1 border-solid flex justify-center items-center">

    ...
    <div>
      <div className="bg-zinc-950 text-neutral-50 w-full h-fit h-fit min-h-screen w-screen min-w-screen max-w-screen overflow-visible">
        <div className="min-h-[1080px] flex w-full">
          <aside className="shrink-0 bg-zinc-900 border-white/10 border-t-0 border-r-1 border-b-0 border-l-0 border-solid flex py-6 flex-col items-center gap-6 w-18">
            <div className="size-10 shadow-[0_0_20px_oklch(0.546_0.245_262.881/0.6)] rounded-xl bg-[#155dfc] flex justify-center items-center">
              <ShieldHalf className="size-5 text-[#1c398e]" />
            </div>
            <nav className="flex px-3 flex-col items-stretch gap-2 w-full">
              <div className="size-12 transition-colors rounded-xl text-[#9f9fa9] flex justify-center items-center">
              ...
              <div className="size-12 shadow-[0_0_18px_oklch(0.546_0.245_262.881/0.55)] rounded-xl bg-[#155dfc] text-[#1c398e] flex justify-center items-center">
            ...
            <div className="size-12 transition-colors rounded-xl text-[#9f9fa9] flex mt-auto justify-center items-center">
              <Settings className="size-5" />
            </div>
          </aside>
          <div className="min-w-0 flex flex-col flex-1">
            <header className="shrink-0 backdrop-blur-md bg-zinc-900/60 border-white/10 border-t-0 border-r-0 border-b-1 border-l-0 border-solid flex px-8 items-center gap-6 h-16">
              ...
              <div className="max-w-md flex ml-4 items-center flex-1 gap-2">
                <div className="rounded-lg bg-zinc-800 border-white/10 border-1 border-solid flex px-3 items-center gap-2 w-full h-9">
              ...
              <div className="flex ml-auto items-center gap-4">
                <div className="rounded-full bg-[#00bc7d]/10 border-[#00bc7d]/30 border-1 border-solid flex px-3 items-center gap-2 h-8">
                  <span className="size-2 animate-pulse rounded-full bg-[#00bc7d]" />
                  <span className="font-medium text-[#00bc7d] text-xs leading-4">
                    All Systems Operational
                  </span>
                </div>
                <Button
                  className="relative size-9 text-[#9f9fa9]"
                  size="icon"
                  variant="ghost"
                >
                  <Bell className="size-5" />
                  <span className="size-2 rounded-full bg-[#ff6467] absolute right-1.5 top-1.5" />
                </Button>
                <Button
                ...
                <div className="border-white/10 border-t-0 border-r-0 border-b-0 border-l-1 border-solid flex pl-4 items-center gap-2">
                  <img
                    alt="Analyst"
                    className="size-9 object-cover ring-2 ring-primary/40 rounded-full"
